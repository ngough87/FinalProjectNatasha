...
{
  return this.http.post<WalkLocation>(this.url + 'api/walkLocation', walkLocation, this.getHttpOptions()).pipe(
    catchError((err: any) => {
...
update(walkLocation: WalkLocation): Observable<WalkLocation> {
  ...
  return this.http.put<WalkLocation>(this.url + 'api/walkLocation/' + walkLocation.id, walkLocation, this.getHttpOptions()).pipe(
    catchError((err: any) => {
      console.log(err);
      return throwError(
...
index(): Observable<WalkLocation[]> {
  ...
  // Create GET request to authenticate credentials
  return this.http.get<WalkLocation[]>(this.url + 'api/walkLocation/', this.getHttpOptions()).pipe(
    catchError((err: any) => {
      console.log(err);
      return throwError(
